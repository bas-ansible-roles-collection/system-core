# System Core (`system-core`) - Testing
...
```shell
mv ~/ansible-system-core ~/system-core
cd tests
pip install ansible
...
available [here](https://semaphoreci.com/antarctica/ansible-system-core).
...
| --------------------------------- | ----------------- | --------------------------------------- | --------------------------- |
| barc-system-core-test-ubuntu-bare | *computed value*  | `barc-system-core-test-ubuntu-bare.v.m` | The VM's private IP address |
| barc-system-core-test-centos-bare | *computed value*  | `barc-system-core-test-centos-bare.v.m` | The VM's private IP address |
